...
class App extends Component {
  ...
  onDeleteHistory = id => {
    ...
    const deletedList = searchHistoryList.filter(eachItem => eachItem.id !== id)
    this.setState({
      searchHistoryList: deletedList,
    })
  }
  ...
  render() {
    ...
    if (newList.length === 0) {
      ...
      resultList = (
        <ul className="history-main-list-container">
    ...
    return (
      <div>
        ...
        <div className="banner-container">{resultList}</div>
      </div>
    )
  }
}
